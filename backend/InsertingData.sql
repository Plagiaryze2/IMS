...
INSERT INTO Suppliers (SupplierName, ContactPerson, Phone, Email, Address, City, IsActive) 
...
BEGIN
    IF NOT EXISTS (SELECT 1 FROM Invoices WHERE InvoiceNumber = 'INV-2026-' + RIGHT('000' + CAST(@j AS NVARCHAR), 3))
    BEGIN
